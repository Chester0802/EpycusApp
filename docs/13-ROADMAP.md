...
| 6 | **Calendar** `[x]` (2026-07-29, ampliado 2026-08-05) | Vista dedicada en `/calendar` con feriados peruanos, semanas de exámenes y misiones del ciclo. Ampliado el 2026-08-05 con la funcionalidad de **Horario de Clases Semanal** (`class_schedules`), modal interactivo por día (Lunes a Domingo), formulario de alta/baja de cursos y etiquetas de color semánticas (`primary`, `accent`, `success`, `warning`, `secondary`). Historias de usuario en `docs/14-HISTORIAS-USUARIO.md`. |
