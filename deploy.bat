...
"C:\Program Files\PuTTY\plink.exe" -batch -hostkey "SHA256:5NPmo7Lsf5dX4VteyZJK2tpslJ3r/zQxyZbWxhjS5+k" -P 65002 -pw "Marco123:)" u897008619@46.202.145.111 "cd /home/u897008619/domains/epycus.es/public_html/app && tar -xzf backend.tar.gz && mkdir -p public/build && tar -xzf build.tar.gz -C public/build && rm -f backend.tar.gz build.tar.gz && rm -f bootstrap/cache/*.php && chmod -R 755 /home/u897008619/domains/epycus.es/public_html/app && chmod -R 775 /home/u897008619/domains/epycus.es/public_html/app/storage && chmod -R 775 /home/u897008619/domains/epycus.es/public_html/app/bootstrap/cache && php artisan migrate --force && php artisan optimize:clear"
