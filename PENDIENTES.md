...
| CRITICO-006 | **Muy Alta** | `appsettings.json` | Google OAuth: `ClientId` y `ClientSecret` son placeholders (`YOUR_GOOGLE_CLIENT_ID...`) | **Muy Alto** | ✅ Corregido | Configurado en `deploy/epycus-web.service` con variables de entorno reales en el VPS. |
