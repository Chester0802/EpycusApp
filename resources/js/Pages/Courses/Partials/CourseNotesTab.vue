...
const activeCourseId = computed(() => props.course?.id);
...
<template>
    <div class="flex-1 flex flex-col min-w-0 bg-surface relative h-[75vh] border border-border rounded-xl overflow-hidden shadow-lg">
