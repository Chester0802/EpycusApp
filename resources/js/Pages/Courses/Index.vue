    ...
    <AppLayout>
        ...
        >
            <form @submit.prevent="submitCourse" class="space-y-6 pb-6">
                ...
                <div v-if="courseForm.hasErrors" class="p-3.5 rounded-xl bg-danger/10 border border-danger/30 text-danger-text text-xs space-y-1.5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1">
                        <BaseInput
                            ...
                            max="20"
                            placeholder="16"
                            :error="courseForm.errors.target_grade"
                        />
                    </div>
                        ...
                        >
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <BaseInput
                                        ...
                                        :error="courseForm.errors['sessions.' + index + '.start_time']"
                                        required
                                    />
                                </div>
                                <div>
                                    ...
                                    <BaseInput
                                        ...
                                        type="time"
                                        aria-label="Hora Fin"
                                        :error="courseForm.errors['sessions.' + index + '.end_time']"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <BaseInput
                                    ...
                                    aria-label="Aula"
                                    :error="courseForm.errors['sessions.' + index + '.classroom']"
                                />
                            </div>
                        </div>
                    </div>
                    <div v-if="courseForm.errors.sessions" class="text-danger text-xs font-semibold">
